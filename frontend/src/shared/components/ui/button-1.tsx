...
const types = {
  primary: "bg-gray-900 hover:bg-gray-800 text-white fill-white",
  secondary: "bg-white hover:bg-gray-50 text-gray-900 fill-gray-900 border border-gray-300",
  tertiary: "bg-none hover:bg-gray-100 text-gray-900 fill-gray-900",
  error: "bg-red-600 hover:bg-red-700 text-white fill-white",
  warning: "bg-amber-600 hover:bg-amber-700 text-black fill-black"
};
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        fullWidth && "w-full",
        variant === "unstyled" 
          ? "outline-none px-0 h-fit bg-transparent hover:bg-transparent text-gray-900" 
          : "focus:ring-2 focus:ring-blue-500 focus:outline-0",
        className
      )}
      {...rest}
    >
